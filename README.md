...
[![GoDoc](https://godoc.org/github.com/tzrd/redisqueue?status.svg)](https://pkg.go.dev/github.com/tzrd/redisqueue/v2?tab=doc)
[![Build Status](https://travis-ci.org/tzrd/redisqueue.svg?branch=master)](https://travis-ci.org/tzrd/redisqueue)
[![Coverage Status](https://coveralls.io/repos/github/tzrd/redisqueue/badge.svg?branch=master)](https://coveralls.io/github/tzrd/redisqueue?branch=master)
[![Go Report Card](https://goreportcard.com/badge/github.com/tzrd/redisqueue)](https://goreportcard.com/report/github.com/tzrd/redisqueue)
![License](https://img.shields.io/github/license/tzrd/redisqueue.svg)
...
go get github.com/tzrd/redisqueue/v2
```

Import:

```go
import "github.com/tzrd/redisqueue/v2"
```
